      ...
      <div>
         ...
         <div>
            ...
            <div className="container-fluid">
              <a className="navbar-brand" href="/">Angel_Helper</a>
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="/Updateprofile">Profiles</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link active" aria-current="page" href="/aboutUs">About Us</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="/LoginComponent">Login</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="/SignupComponent">Signup</a>
                  </li>
